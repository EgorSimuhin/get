...
class asteroid {
private:
    static int count[3]; // Массив для хранения количества разновидностей астероидов
    int type; // Тип астероида
...
public:
    ...
    static void printCount() {
        ...
        for (int i = 0; i < 3; i++) {
            std::cout << "Type " << i << ": " << count[i] << std::endl;
        }
    }
bool Dangerous(){
        return 1;
